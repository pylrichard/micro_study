...
func (c *userSrvService) QueryUserByName(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserSrv.QueryUserByName", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (h *userSrvHandler) QueryUserByName(ctx context.Context, in *Request, out *Response) error {
	return h.UserSrvHandler.QueryUserByName(ctx, in, out)
}
